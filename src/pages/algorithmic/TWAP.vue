  ...
  <section>
    ...
    <el-dialog :title="form && form.id ? '编辑' : '新增'" :visible.sync="formVisible" :close-on-click-modal="false">
      <el-form :model="form" label-width="120px" :rules="rules" ref="form" label-position="left">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item  label="间隔时间(秒)" prop="min_waitTime" :rules="[{ required: true, message: ' ', trigger: 'blur' }]">
          ...
          <el-col :span="12">
            <el-form-item  label="订单时间(分钟)" prop="amount_start" :rules="[{ required: true, message: ' ', trigger: 'blur' }]">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="最大买卖数量" prop="quote_buffer" :rules="[{ required: true, message: ' ', trigger: 'blur' }]">
